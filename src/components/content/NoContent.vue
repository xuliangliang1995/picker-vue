<template>
    <div :style="{height:contentHeight}">
        <a-row :style="{height:'80%'}" type="flex" justify="center" align="middle">
            <div class="ant-empty" data-v-21b4b419=""><div class="ant-empty-image">
                ...
                <p class="ant-empty-description">{{tip}}</p></div>
        </a-row>
    </div>
</template>
...
<script>
    export default {
        ...
        data () {
            return {
                tip: '暂无数据',
                contentHeight: (window.screen.height * 80 / 100) + "px"
            }
        },
        created() {
            if (this.content) {
